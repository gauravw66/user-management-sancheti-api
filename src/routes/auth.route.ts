...
class AuthRoute implements Routes {
  ...
  private initializeRoutes() {
    ...
    this.router.post(
      `${this.path}resetPasswordRequest`,
      this.authController.resetPasswordRequest
    );
    this.router.post(
    ...
    this.router.post(
      ...
      authMiddleware,
      this.authController.updateUserType
    );
    this.router.get(`${this.path}logo`, this.authController.logo);
    this.router.get(
      `${this.path}getUserCount`,
      this.authController.getUserCount
    );
    this.router.post(
      `${this.path}updateUserMobile`,
      authMiddleware,
      this.authController.updateUserMobile
    );
  }
}

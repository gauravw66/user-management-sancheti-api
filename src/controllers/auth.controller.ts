...
class AuthController {
  ...
  public resetPasswordRequest = async (req: Request, res: Response, next: NextFunction): Promise<any> => {
    try {
      const userData: any = req.body;
      const resetPasswordRequest = await this.authService.resetPasswordRequest(userData);
  ...
  public resetPassword = async (req: Request, res: Response, next: NextFunction): Promise<any> => {
    try {
      ...
      const resetPasswordForUser = await this.authService.resetPassword(userData , id );
  ...
  public updateUserType = async (req: RequestWithUser, res: Response, next: NextFunction): Promise<void> => {
    try {
      let userData = req.body
      const changeUserType = await this.authService.changeUserType(userData);

      res.status(200).json({ data: changeUserType, message: 'User type chnaged successfully' });
    } catch (error) {
      next(error);
    }
  };

  public logo = async (req: RequestWithUser, res: Response, next: NextFunction): Promise<void> => {
    try {
  ...
  public getUserCount = async (req: RequestWithUser, res: Response, next: NextFunction): Promise<void> => {
    try {
